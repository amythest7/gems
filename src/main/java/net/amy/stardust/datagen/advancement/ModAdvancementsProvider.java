package net.amy.stardust.datagen.advancement;
...
public class ModAdvancementsProvider extends AdvancementProvider {
    public ModAdvancementsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, List.of(new StardustAdvancements()));
    }


    public static class StardustAdvancements implements AdvancementSubProvider {
        ...
        public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> output) {
            ...
            AdvancementHolder root = Advancement.Builder.advancement()
                    .display(
                            Items.IRON_PICKAXE,
                            Component.translatable("advancement.stardust.root.title"),
                            Component.translatable("advancement.stardust.root.description"),
                    ...
                    .save(output, MOD_ID + ":stardust/root");

            AdvancementHolder gemRing = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.DIAMOND_GOLD_RING,
                            Component.translatable("advancement.stardust.gem_ring.title"),
                            Component.translatable("advancement.stardust.gem_ring.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/gem_ring");

            AdvancementHolder gemNetheriteRing = Advancement.Builder.advancement()
                    .parent(gemRing)
                    .display(
                            ModItems.DIAMOND_NETHERITE_RING,
                            Component.translatable("advancement.stardust.gem_netherite_ring.title"),
                            Component.translatable("advancement.stardust.gem_netherite_ring.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/gem_netherite_ring");

            AdvancementHolder gemStardustRing = Advancement.Builder.advancement()
                    .parent(gemNetheriteRing)
                    .display(
                            ModItems.DIAMOND_STARDUST_RING,
                            Component.translatable("advancement.stardust.gem_stardust_ring.title"),
                            Component.translatable("advancement.stardust.gem_stardust_ring.description"),
                            null,
                    ...
                    .save(output, MOD_ID + ":stardust/gem_stardust_ring");
            ...
            AdvancementHolder determination = Advancement.Builder.advancement()
                    ...
                    .display(
                            ModItems.RUBY_HEART,
                            Component.translatable("advancement.stardust.determination.title"),
                            Component.translatable("advancement.stardust.determination.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/determination");

            AdvancementHolder bravery = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.CITRINE_HEART,
                            Component.translatable("advancement.stardust.bravery.title"),
                            Component.translatable("advancement.stardust.bravery.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/bravery");

            AdvancementHolder justice = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.TOPAZ_HEART,
                            Component.translatable("advancement.stardust.justice.title"),
                            Component.translatable("advancement.stardust.justice.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/justice");

            AdvancementHolder kindness = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.EMERALD_HEART,
                            Component.translatable("advancement.stardust.kindness.title"),
                            Component.translatable("advancement.stardust.kindness.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/kindness");

            AdvancementHolder patience = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.AQUAMARINE_HEART,
                            Component.translatable("advancement.stardust.patience.title"),
                            Component.translatable("advancement.stardust.patience.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/patience");

            AdvancementHolder integrity = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.SAPPHIRE_HEART,
                            Component.translatable("advancement.stardust.integrity.title"),
                            Component.translatable("advancement.stardust.integrity.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/integrity");

            AdvancementHolder perseverance = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.AMETHYST_HEART,
                            Component.translatable("advancement.stardust.perseverance.title"),
                            Component.translatable("advancement.stardust.perseverance.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/perseverance");

            AdvancementHolder doki = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            ModItems.SPINEL_HEART,
                            Component.translatable("advancement.stardust.doki.title"),
                            Component.translatable("advancement.stardust.doki.description"),
                            null,
                            AdvancementType.TASK,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/doki");

            /*AdvancementHolder maxDoki = Advancement.Builder.advancement()
                    .parent(doki)
                    .display(
                            ModItems.SPINEL_HEART,
                            Component.translatable("advancement.stardust.max_doki.title"),
                            Component.translatable("advancement.stardust.max_doki.description"),
                            null,
                            AdvancementType.CHALLENGE,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/max_doki");*/

            AdvancementHolder omega = Advancement.Builder.advancement()
                    .parent(determination)
                    .display(
                            ModItems.OMEGA_HEART,
                            Component.translatable("advancement.stardust.omega.title"),
                            Component.translatable("advancement.stardust.omega.description"),
                            null,
                            AdvancementType.CHALLENGE,
                            true,
                            true,
                    ...
                    .save(output, MOD_ID + ":stardust/omega");
