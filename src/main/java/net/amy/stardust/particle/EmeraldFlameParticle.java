...
public class EmeraldFlameParticle extends RisingParticle {
    private EmeraldFlameParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new EmeraldFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
        }
    }
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            EmeraldFlameParticle particle = new EmeraldFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
            particle.scale(0.5F);
            return particle;
        }
    }
