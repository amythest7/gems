...
public class AmethystFlameParticle extends RisingParticle {
    private AmethystFlameParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new net.amy.stardust.particle.AmethystFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
        }
    }
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            AmethystFlameParticle particle = new AmethystFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
            particle.scale(0.5F);
            return particle;
        }
    }
