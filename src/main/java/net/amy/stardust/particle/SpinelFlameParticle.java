...
public class SpinelFlameParticle extends RisingParticle {
    private SpinelFlameParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new SpinelFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
        }
    }
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            SpinelFlameParticle particle = new SpinelFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
            particle.scale(0.5F);
            return particle;
        }
    }
