...
public class TopazFlameParticle extends RisingParticle {
    private TopazFlameParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new TopazFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
        }
    }
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            TopazFlameParticle particle = new TopazFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
            particle.scale(0.5F);
            return particle;
        }
    }
