...
public class RubyFlameParticle extends RisingParticle {
    private RubyFlameParticle(
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            return new RubyFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
        }
    }
    ...
    public static class SmallFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            RubyFlameParticle particle = new RubyFlameParticle(level, x, y, z, xAux, yAux, zAux, this.sprite.get(random));
            particle.scale(0.5F);
            return particle;
        }
    }
